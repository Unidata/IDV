/*
 * $Id: SaturationEquivalentPotentialTemperature.java,v 1.9 2005/05/13 18:35:42 jeffmc Exp $
 *
 ...
 */
public final class SaturationEquivalentPotentialTemperature
        extends EquivalentPotentialTemperature {
    ...
    public static Data create(Data pressure, Data temperature)
        ...
        return Util.clone(
            EquivalentPotentialTemperature.create(
                pressure, temperature, SaturationMixingRatio.create(
                    pressure, temperature)), getRealType());
    }
}
