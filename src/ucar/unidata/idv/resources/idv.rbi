...
<!-- Where do we find the xml definition of the 'favorites' bundles   -->
  <resources name="idv.resource.bundlexml">
    ...
    <resource location="https://ramadda.unidata.ucar.edu/repository/entry/show?entryid=5096049b-17cb-443a-9c85-d9795b954a2e&amp;output=idv.bundles&amp;depth=5&amp;top= "/>
    <resource location="https://ramadda.unidata.ucar.edu/repository/entry/show?entryid=499df7f2-6d4e-426e-852b-92d4a282b94a&amp;output=idv.bundles&amp;depth=5&amp;top= "/>
  </resources>
...
<!-- Default font   -->
  <resources name="idv.resource.defaultfont">
    <resource  location="%IDVPATH%/defaultfont/SourceCodePro_Black.ttf"/>
    <resource  location="%IDVPATH%/defaultfont/SourceCodePro_Bold.ttf"/>
    <resource  location="%IDVPATH%/defaultfont/SourceCodePro_ExtraLight.ttf"/>
    <resource  location="%IDVPATH%/defaultfont/SourceCodePro_Light.ttf"/>
    <resource  location="%IDVPATH%/defaultfont/SourceCodePro_Medium.ttf"/>
    <resource  location="%IDVPATH%/defaultfont/SourceCodePro_Regular.ttf"/>
    <resource  location="%IDVPATH%/defaultfont/SourceCodePro_Semibold.ttf"/>
  </resources>
<!-- Python libraries    -->
...
<!-- Where to look for extensions  -->
  <resources name="idv.resource.pluginindex">
    <resource location="https://resources.unidata.ucar.edu/idv/plugins/plugins.xml"/>
  </resources>
...
<!-- Defines the image set xml   -->
  <resources name="idv.resource.imagesets">
    ...
    <resource location="https://resources.unidata.ucar.edu/georesources/webcams/images/index.xml"/>
  </resources>
