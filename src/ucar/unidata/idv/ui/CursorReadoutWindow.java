...
public class CursorReadoutWindow {
    ...
    public void handleMousePressedOrDragged(MouseEvent e) throws RemoteException, VisADException {
        ...
        // re-create the EarthLocationTuple, ensuring a longitude between -180 and 180
        lastEarthLocation = new EarthLocationTuple(lastEarthLocation.getLatitude().getValue(),
        		Misc.normalizeLongitude(lastEarthLocation.getLongitude().getValue()),
