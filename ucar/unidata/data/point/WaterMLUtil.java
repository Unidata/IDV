...
public static final String TAG_LOCATIONPARAM = "locationParam";
public static final String TAG_VARIABLEPARAM = "variableParam";
public static final String TAG_TIMEPARAM = "timeParam";
public static final String TAG_BEGINDATETIME = "beginDateTime";
...
public static final String ATTR_PROJECTIONINFORMATION = "projectionInformation";
...
public static final String ATTR_UNITSABBREVIATION = "unitsAbbreviation";
public static final String ATTR_UNITSCODE = "unitsCode";
...
public static final String ATTR_QUALITYCONTROLLEVEL = "qualityControlLevel";
public static final String ATTR_SAMPLEID = "sampleID";
