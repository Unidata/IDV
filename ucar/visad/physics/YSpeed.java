/*
 * $Id: YSpeed.java,v 1.10 2006/03/17 17:08:53 jeffmc Exp $
 *
...
/**
 * Provides support for the quantity of speed in the Y direction.
 *
 * @author Steven R. Emmerson
 * @version $Revision: 1.10 $ $Date: 2006/03/17 17:08:53 $
 */
public class YSpeed extends Speed {
     ...
     */
    private static volatile YSpeed instance;
    ...
    static {
        try {
            ...
            System.err.println(
                "YSpeed.<clinit>(): Couldn't initialize class: " + e);
            System.exit(1);
        }
    }
    ...
    /**
     * Constructs from nothing.  The name will be "Y_Speed".
     *
     * @throws VisADException   Couldn't create necessary VisAD object.
     * @see #YSpeed(String name)
     */
    private YSpeed() throws VisADException {
        this("Y_Speed");
    }
     ...
     * @throws VisADException   Couldn't create necessary VisAD object.
     * @see #YSpeed(String name, Unit unit)
     */
    protected YSpeed(String name) throws VisADException {
     ...
     * @throws VisADException   Couldn't create necessary VisAD object.
     * @see #YSpeed(String name, Unit unit, Set set)
     */
    protected YSpeed(String name, Unit unit) throws VisADException {
     ...
     */
    protected YSpeed(String name, Unit unit, Set set) throws VisADException {
        super(name, unit, set);
    }
