/**
 * $Id: NetcdfPointFeatureDataSource.java,v 1.32 2007/07/31 19:29:16 jeffmc Exp $
 *
 ...
 */
public class NetcdfPointFeatureDataSource extends PointDataSource {


    /** logging category */
    static LogUtil.LogCategory log_ =
        LogUtil.getLogInstance(NetcdfPointFeatureDataSource.class.getName());
     ...
     */
    public NetcdfPointFeatureDataSource() throws VisADException {
        init();
    }

    /**
     * Create a new NetcdfPointFeatureDataSource
     *
     ...
     *
     */
    public NetcdfPointFeatureDataSource(DataSourceDescriptor descriptor,
    ...
    /**
     * Check to see if this NetcdfPointFeatureDataSource is equal to the object
     * in question.
     *
    ...
    public boolean equals(Object o) {
        if ( !(o instanceof NetcdfPointFeatureDataSource)) {
            return false;
        }
        NetcdfPointFeatureDataSource that = (NetcdfPointFeatureDataSource) o;
        return (this == that);
    }
    ...
    public PointDatasetImpl getDataset() {
        if (dataset == null) {
            Trace.call1("NetcdfPointFeatureDataSource.getDataSet",
                        " name = " + sources);
            dataset = doMakeDataset();
            Trace.call2("NetcdfPointFeatureDataSource.getDataSet");
        }
        return dataset;
    }
    ...
    protected FieldImpl makeObs(DataChoice dataChoice, DataSelection subset,
        ...
        FieldImpl obs = null;
        Trace.call1("NetcdfPointFeatureDatasource:makeObs");
        if (obs == null) {
        ...
        Trace.call2("NetcdfPointFeatureDatasource:makeObs");
        return obs;
    }
