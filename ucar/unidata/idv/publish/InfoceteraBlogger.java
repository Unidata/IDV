 ...
 */
public class InfoceteraBlogger extends ServerPublisher {
     ...
     */
    public InfoceteraBlogger(IntegratedDataViewer idv, Element element) {
        super(idv, element);
    }
    ...
    public boolean isConfigured() {
        return super.isConfigured() && defined(dirPath);
    }
    ...
    public boolean configure() {
        JTextField serverFld   = new JTextField((server == null)
                                                ? ""
                                                : server, 30);
        JTextField portFld     = new JTextField("" + port, 4);
        ...
        JTextField userFld     = new JTextField((user == null)
                                                ? ""
                                                : user, 30);
        JTextField dirFld      = new JTextField((dirPath == null)
                                                ? ""
                                                : dirPath, 30);
        ...
        comps.add(
            GuiUtils.inset(
                GuiUtils.leftCenter(portFld, GuiUtils.filler()), 4));
        ...
        comps.add(GuiUtils.rLabel(" Infocetera directory: "));
        comps.add(GuiUtils.inset(dirFld, 4));
