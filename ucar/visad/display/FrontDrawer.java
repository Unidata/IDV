...
public class FrontDrawer extends DisplayableData {
     ...
     * _more_
     *
     * @param fsegment _more_
     * @param rsegment _more_
     * @param fshapes _more_
     * @param fred _more_
     * @param fgreen _more_
     * @param fblue _more_
     * @param rshapes _more_
     * @param rred _more_
     * @param rgreen _more_
     * @param rblue _more_
     *
    ...
    private static final float[][] rredarray = {
        ...
        { 0.5f }, { 0.5f }, { 1.0f }, { 0.5f }, { 0.5f }, { 0.5f, 0.5f },  // DRY_LINE = 14
        { 1.0f }, { 1.0f, 1.0f },  // LIFTED_INDEX = 16
    ...
    private static final float[][] rgreenarray = {
        ...
        { 1.0f, 1.0f }, { 1.0f, 1.0f }, { 1.0f, 1.0f }, { 1.0f, 1.0f },
        { 0.3f }, { 0.3f }, { 1.0f }, { 0.5f }, { 0.5f }, { 0.3f, 0.3f },  // DRY_LINE = 14
        { 1.0f }, { 1.0f, 1.0f },  // LIFTED_INDEX = 16
        { 1.0f }, { 1.0f }, { 1.0f }, { 1.0f }, { 0.5f }
    };
    ...
    private static final float[][] rbluearray = {
        ...
        { 1.0f, 1.0f }, { 1.0f, 1.0f }, { 1.0f, 1.0f }, { 1.0f, 1.0f },
        { 0.0f }, { 0.0f }, { 1.0f }, { 1.0f }, { 1.0f }, { 0.0f, 0.0f },  // DRY_LINE = 14
        { 1.0f }, { 1.0f, 1.0f },  // LIFTED_INDEX = 16
    ...
    private static final float[][] fredarray = {
        null, null, null, null, null, null, null, null, null, null, null,
        null, { 0.5f }, { 0.5f }, null, null, null, null, null, null, null,
        { 0.5f }
    };
    ...
    private static final float[][] fbluearray = {
        null, null, null, null, null, null, null, null, null, null, null,
        null, { 1.0f }, { 1.0f }, null, null, null, null, null, null, null,
        { 1.0f }
    };
