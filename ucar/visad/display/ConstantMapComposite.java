/*
 * $Id: ConstantMapComposite.java,v 1.9 2005/05/13 18:34:37 jeffmc Exp $
 *
...
public class ConstantMapComposite implements ConstantMaps {
            ...
            public void visit(ConstantMapAdapter mapAdapter)
                ...
                if (mapSet.contains(mapAdapter)) {
                    throw new BadMappingException(
                        getClass().getName() + ".visit(): "
                        + "ConstantMapAdapter already exists: " + mapAdapter);
                }
    ...
    public void addPropertyChangeListener(String name,
        ...
        for (Iterator iter = mapSet.iterator(); iter.hasNext(); ) {
            ((ConstantMapAdapter) iter.next()).addPropertyChangeListener(name,
                    listener);
        }
    }
