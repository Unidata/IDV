/*
 * $Id: TrexIdv.java,v 1.2 2006/10/25 16:50:55 jeffmc Exp $
 *
...
public class TrexIdv extends IntegratedDataViewer {
    ...
    /**
     * Create the TrexIdv with the given command line arguments.
     ...
     *
     */
    public TrexIdv(String[] args) throws VisADException, RemoteException {
        super(args);
        init();
    }
    ...
    public void initPropertyFiles(List files) {
        files.clear();
        files.add("/ucar/unidata/apps/trex/trex.properties");
    }
    ...
    /**
     * The main. Configure the logging and create the TrexIdv
     *
     * @param args Command line arguments
     *
