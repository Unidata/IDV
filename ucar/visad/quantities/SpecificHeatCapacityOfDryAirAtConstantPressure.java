/*
 * $Id: SpecificHeatCapacityOfDryAirAtConstantPressure.java,v 1.9 2005/05/13 18:35:45 jeffmc Exp $
 *
 ...
 * @version $Id: SpecificHeatCapacityOfDryAirAtConstantPressure.java,v 1.9 2005/05/13 18:35:45 jeffmc Exp $
 */
public class SpecificHeatCapacityOfDryAirAtConstantPressure
        extends SpecificHeatCapacityOfDryAir {
     ...
     */
    private SpecificHeatCapacityOfDryAirAtConstantPressure()
    ...
    public static RealType getRealType() throws VisADException {
        ...
        if (realType == null) {
            synchronized (
                SpecificHeatCapacityOfDryAirAtConstantPressure.class) {
                if (realType == null) {
        ...
        if (real == null) {
            synchronized (
                ...
                if (real == null) {
                     ...
                     */
                    real = new Real(getRealType(), 1004.832);
                }
            }
        }
