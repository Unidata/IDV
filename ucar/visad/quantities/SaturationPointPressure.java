...
public final class SaturationPointPressure extends AirPressure {
     ...
     */
    public static Data create(Data pressure, Data temperature, Data saturationPointTemperature)
        ...
        return Util.clone(
            VisADMath.multiply(
                pressure,
                VisADMath.pow(
                    VisADMath.divide(saturationPointTemperature, temperature),
                    getExponent())), getRealType());
    }
}
