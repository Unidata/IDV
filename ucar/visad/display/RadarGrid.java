/*
 * $Id: RadarGrid.java,v 1.25 2005/05/13 18:34:44 jeffmc Exp $
 *
...
public class RadarGrid extends CompositeDisplayable {
     ...
     * @throws VisADException   problem creating VisAD object
     */
    public void setCenterPointAndColors(double lat, double lon, Color rrcolor, Color radcolor, Color lcolor)
            throws VisADException, RemoteException {
        lineColor  = radcolor;
        ringColor  = rrcolor;
        labelColor = lcolor;
