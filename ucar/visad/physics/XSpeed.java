/*
 * $Id: XSpeed.java,v 1.8 2006/03/17 17:08:53 jeffmc Exp $
 *
...
/**
 * Provides support for the quantity of speed in the X direction.
 *
 * @author Steven R. Emmerson
 * @version $Revision: 1.8 $ $Date: 2006/03/17 17:08:53 $
 */
public class XSpeed extends Speed {
     ...
     */
    private static volatile XSpeed instance;
    ...
    static {
        try {
            ...
            System.err.println(
                "XSpeed.<clinit>(): Couldn't initialize class: " + e);
            System.exit(1);
        }
    }
    ...
    /**
     * Constructs from nothing.  The name will be "X_Speed".
     *
     * @throws VisADException   Couldn't create necessary VisAD object.
     * @see #Speed(String name)
     */
    private XSpeed() throws VisADException {
        this("X_Speed");
    }
     ...
     * @throws VisADException   Couldn't create necessary VisAD object.
     */
    protected XSpeed(String name) throws VisADException {
     ...
     * @throws VisADException   Couldn't create necessary VisAD object.
     */
    protected XSpeed(String name, Unit unit) throws VisADException {
     ...
     */
    protected XSpeed(String name, Unit unit, Set set) throws VisADException {
        super(name, unit, set);
    }
