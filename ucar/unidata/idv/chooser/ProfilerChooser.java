/*
 * $Id: ProfilerChooser.java,v 1.38 2007/07/06 20:40:17 jeffmc Exp $
 *
...
public class ProfilerChooser extends ucar.unidata.idv.chooser.adde
    .AddeProfilerDataChooser {


    /**
     * Construct a <code>Profiler Chooser</code> using the manager
     ...
     */
    public ProfilerChooser(IdvChooserManager mgr, Element root) {
        super(mgr, root);
    }
