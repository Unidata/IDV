...
sudo curl -v -j -k -L -H "Cookie: oraclelicense=accept-securebackup-cookie"  http://download.oracle.com/otn-pub/java/jdk/8u112-b15/jre-8u112-linux-x64.tar.gz > /home/vagrant/download/jre-8u112-linux-x64.tar.gz

sudo tar xzfv /home/vagrant/download/jre-8u112-linux-x64.tar.gz -C /home/vagrant/download
