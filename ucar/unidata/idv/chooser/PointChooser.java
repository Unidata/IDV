/*
 * $Id: PointChooser.java,v 1.41 2007/07/06 20:40:17 jeffmc Exp $
 *
 ...
 */
public class PointChooser extends ucar.unidata.idv.chooser.adde
    .AddePointDataChooser {


    /**
     * Construct a <code>PointChooser</code> using the manager
    ...
    public PointChooser(IdvChooserManager mgr, Element root) {
        super(mgr, root);
    }
