 ...
 *
 * @author Don Murray
 * @version $Id: CartesianHorizontalWindOfGeopotentialAltitude.java,v 1.10 2005/05/13 18:34:49 jeffmc Exp $
 */
public final class CartesianHorizontalWindOfGeopotentialAltitude extends CartesianHorizontalWindProfile {
     ...
     */
    private static CartesianHorizontalWindOfGeopotentialAltitude INSTANCE;
    ...
    public static FunctionType instance() throws VisADException {
        ...
        if (INSTANCE == null) {
            synchronized (
                CartesianHorizontalWindOfGeopotentialAltitude.class) {
                if (INSTANCE == null) {
                    INSTANCE =
                        new CartesianHorizontalWindOfGeopotentialAltitude();
                }
            }
        }
