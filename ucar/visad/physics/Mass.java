/*
 * $Id: Mass.java,v 1.8 2006/03/17 17:08:51 jeffmc Exp $
 *
...
/**
 * Provides support for the quantity of mass.
 *
 * @author Steven R. Emmerson
 * @version $Revision: 1.8 $ $Date: 2006/03/17 17:08:51 $
 */
public class Mass extends ScalarQuantity {
    ...
    static {
        ...
        try {
            kg       = SI.kilogram;
            g        = kg.scale(1e-3).clone("g");
            lb       = kg.scale(4.5359237e-1).clone("lb");
            instance = new Mass(kg);
        } catch (Exception e) {
            kg = null;  // to fool compiler
            g  = null;  // to fool compiler
            lb = null;  // to fool compiler

            System.err.println("Mass.<clinit>(): Couldn't initialize class: "
                               + e);
            System.exit(1);
        }
    ...
    /**
     * Constructs from a unit.  The name will be "Mass".
     *
     * @param unit              The unit of the quantity.
     * @throws VisADException   Couldn't create necessary VisAD object.
     * @see #Mass(String name, Unit unit)
     */
    private Mass(Unit unit) throws VisADException {
        this("Mass", unit);
    }
     ...
     * @see #Mass(String name, Unit unit)
     */
    protected Mass(String name) throws VisADException {
     ...
     * @throws VisADException   Couldn't create necessary VisAD object.
     * @see #Mass(String name, Unit unit, Set set)
     */
    protected Mass(String name, Unit unit) throws VisADException {
     ...
     * @throws VisADException   Couldn't create necessary VisAD object.
     * @see #Mass(RealType type)
     */
    protected Mass(String name, Unit unit, Set set) throws VisADException {
     ...
     */
    protected Mass(RealType type) throws VisADException {
        super(type);
    }
