...
public class DataJythonTypeHandler extends JythonTypeHandler {
    ...
    protected void processEntry(Request request, PythonInterpreter interp, InputInfo info, JythonTypeHandler.ProcessInfo processInfo, Entry theEntry) throws Exception {
    ...
    protected void cleanup(Request request, Entry entry, PythonInterpreter interp, JythonTypeHandler.ProcessInfo processInfo) throws Exception {
        ...
        for (int i = 0; i < dataProcessInfo.ncPaths.size(); i++) {
            dataOutputHandler.returnNetcdfDataset(dataProcessInfo.ncPaths.get(i),
                                                  dataProcessInfo.ncData.get(i));
        }
        for (int i = 0; i < dataProcessInfo.gridPaths.size(); i++) {
            dataOutputHandler.returnGridDataset(dataProcessInfo.gridPaths.get(i),
    ...
    public static class DataProcessInfo extends JythonTypeHandler.ProcessInfo {
