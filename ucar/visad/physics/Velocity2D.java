/*
 * $Id: Velocity2D.java,v 1.9 2006/03/17 17:08:53 jeffmc Exp $
 *
...
public class Velocity2D extends TupleQuantity {
     ...
     * @throws VisADException   Couldn't create necessary VisAD object.
     */
    protected Velocity2D(String name, ScalarQuantity comp1, ScalarQuantity comp2, CoordinateSystem coordSys)
            throws VisADException {
