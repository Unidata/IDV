/*
 * $Id: Time.java,v 1.9 2006/03/17 17:08:52 jeffmc Exp $
 *
...
/**
 * Provides support for the quantity of absolute time.
 *
 * @author Steven R. Emmerson
 * @version $Revision: 1.9 $ $Date: 2006/03/17 17:08:52 $
 */
public class Time extends ScalarQuantity {
    ...
    /**
     * The Unix unit for this quantity.
     */
    public static final Unit SECONDS_SINCE_THE_EPOCH =
        RealType.Time.getDefaultUnit();

    /**
     * The default unit for this quantity (same the Unix unit).
     */
    public static final Unit DEFAULT_UNIT = SECONDS_SINCE_THE_EPOCH;
    ...
    static {
        try {
            ...
            System.err.println("Time.<clinit>: Couldn't initialize class: "
                               + e);
            System.exit(1);
        }
    }
    ...
    /**
     * Constructs from nothing.  Uses {@link visad.RealType#Time}.
     *
     * @throws VisADException
     */
    private Time() throws VisADException {
        super(RealType.Time);
    }
     ...
     * @see #Time(String, Unit)
     */
    protected Time(String name) throws VisADException {
     ...
     * @see #Time(String name, Unit unit, Set set)
     */
    protected Time(String name, Unit unit) throws VisADException {
     ...
     */
    protected Time(String name, Unit unit, Set set) throws VisADException {
        super(name, unit, set);
    }
