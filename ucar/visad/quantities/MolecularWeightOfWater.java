/*
 * $Id: MolecularWeightOfWater.java,v 1.9 2005/05/13 18:35:41 jeffmc Exp $
 *
 ...
 * @version $Id: MolecularWeightOfWater.java,v 1.9 2005/05/13 18:35:41 jeffmc Exp $
 */
public class MolecularWeightOfWater extends ScalarQuantity {
    ...
    /** Real representing this quantity */
     ...
     */
    private MolecularWeightOfWater() throws VisADException {
        super(getRealType());
    }
    ...
    public static RealType getRealType() throws VisADException {
        ...
        if (realType == null) {
            synchronized (MolecularWeightOfWater.class) {
                if (realType == null) {
                    try {
                        realType =
                            RealType.getRealType("MolecularWeightOfWater",
        ...
        if (real == null) {
            synchronized (MolecularWeightOfWater.class) {
                if (real == null) {
                     ...
                     */
                    real = new Real(getRealType(), 0.018016);
                }
            }
        }
